...
Sämtliche Funktionalität wird in TypeScript implementiert, sofern dies nicht aus bestimmten Gründen anders notwendig ist. Es wird, wo möglich Funktionale Programmierung eingesetzt, um die Testbarkeit des Codes zu erleichtern. Da \gls{GWA} unabdingbar über Seiteneffekte verfügen muss, um die gewünschten Projekte erzeugen zu können, ist ein reines Vorgehen nach Funktionaler Programmierung nicht möglich. Zudem soll testgetrieben entwickelt werden.
