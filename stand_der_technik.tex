...
Der Begriff der Testgetriebenen Entwicklung, im Englischen auch \gls{TDD} genannt, bezeichnet ein bestimmtes Vorgehen beim Programmieren, das zu zuverlässigerem und minimalerem Code führen soll, als er sonst entstehen würde \cite{tdd_beck}
