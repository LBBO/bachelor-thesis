...
Die erste weit verbreitete Art von Computerprogrammen waren sogenannte Kommandozeileninterfaces (\gls{CLI}s). Über die Kommandozeile konnten diese Programme über ihren Namen bzw. ihren Speicherort aufgerufen werden, wobei zusätzliche Argumente übergeben werden konnten, um den Ablauf des Programms zu beeinflussen\cite{verma2013gracoli}.
